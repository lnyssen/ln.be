...
export default function SwissThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative box-content h-[24px] w-[48px] shrink-0 rounded-full border border-[var(--rule)] p-[3px] transition-colors duration-200 hover:border-[var(--accent)]"
    >
      ...
      <span
        className="theme-knob pointer-events-none absolute left-[3px] top-[3px] h-[24px] w-[24px] rounded-full bg-[var(--ink)]"
        aria-hidden="true"
      />
    </button>
  );
